...
module.exports = class GuildMemberAddEvent extends BaseEvent {
  ...
  async run(client, member) {
    ...
    const channel = member.guild.channels.cache.find(ch => ch.name === 'mod-logs' || ch.name === 'goog');
    ...
    member.roles.add(member.guild.roles.cache.find(role => role.name === "Member")).catch(console.error);
  }
}